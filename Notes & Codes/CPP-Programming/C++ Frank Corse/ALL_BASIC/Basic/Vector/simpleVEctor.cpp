...
int main()
{
    ...
    // cout<<"Enter 5 Number :\n";
    // cin>>no[0]>>no.at(1)>>no.at(2)>>no.at(3)>>no.at(4); 
    // no[] also right like array  |||  no.at() like vector is also roght
    // cout<<"Elements are :\n";
    ...
    no.push_back(no1);
    cout<<"Elments are : \n";
    cout<<no.at(0)<<endl<<no.at(1)<<endl<<no.at(2)<<endl
    <<no.at(3)<<endl<<no.at(4)<<endl<<no[5]<<endl<<no.at(6)<<endl;
