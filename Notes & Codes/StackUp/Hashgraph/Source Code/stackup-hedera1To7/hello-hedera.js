...
async function helloWorld() {
    ...
    const contractExecTx = await new ContractExecuteTransaction()
        .setContractId(newContractId)
        .setGas(100000)
        .setFunction("set_message", new ContractFunctionParameters().addString("Hello from REPLACE-WITH-STACKUP-USERNAME"));
    ...
    console.log("The updated contract message: Hello from Arun");
